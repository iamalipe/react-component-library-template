...
export class Logging {
  ...
  private styles: { [key: string]: string } = {
    DEBUG:
      "display: inline-block; background-color: Blue; color: white; font-weight: bold; padding: 3px 7px 3px 7px; border-radius: 3px;",
    ...
    ERROR:
      "display: inline-block; background-color: Red; color: black; font-weight: bold; padding: 3px 7px 3px 7px; border-radius: 3px;",
  };
